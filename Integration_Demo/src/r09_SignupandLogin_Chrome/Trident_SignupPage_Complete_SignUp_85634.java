...
public class Trident_SignupPage_Complete_SignUp_85634 {
	private Logger Log = Logger.getLogger(Trident_SignupPage_Complete_SignUp_85634.class.getName());
	@Test
 	public  void SignupPage_Complete_SignUp() throws IOException {
	 ...
	 signUpPageController.enterEmailIdLogIn("divya.h.gupta@accenture.com");
	 signUpPageController.clickSignUpButton();
	//Add validation that a new page is loaded after clicking on log in
	}
	 @BeforeMethod
